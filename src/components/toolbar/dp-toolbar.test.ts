...
describe('dp-toolbar', () => {
  it('renders the title when no subtitle is given', async () => {
    const el = await fixture<DpToolbar>(html`<dp-toolbar title="My App"></dp-toolbar>`)
  ...
  it('prefers subtitle over title when both are given', async () => {
    const el = await fixture<DpToolbar>(html`<dp-toolbar title="My App" subtitle="Settings"></dp-toolbar>`)
  ...
  it('renders and wires the toggle button when show-toggle is set', async () => {
    const el = await fixture<DpToolbar>(html`<dp-toolbar title="My App" show-toggle></dp-toolbar>`)
  ...
  it('reflects drag-region as an attribute distinct from the native draggable property', async () => {
    const el = await fixture<DpToolbar>(html`<dp-toolbar title="My App" drag-region></dp-toolbar>`)
